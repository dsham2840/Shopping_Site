...
products[0] = new Product("capo", "Quick Change Six-String Capo",  10.99);
products[1] = new Product("strap1", "3-Inch Leather Strap",    10.99);
products[2] = new Product("picks", "6-Pack Various Picks",  2.50);
products[3] = new Product("strap-red", "Nylon Strap (Red)",  3.99);
products[4] = new Product("strap-orange", "Nylon Strap (Orange)", 3.99);
products[5] = new Product("strap-yellow", "Nylon Strap (Yellow)",  3.99);
products[6] = new Product("strap-green", "Nylon Strap (Green)",  3.99);
products[7] = new Product("strap-blue", "Nylon Strap (Blue)",  3.99);
products[8] = new Product("strap-purple", "Nylon Strap (Purple)",  3.99);
products[9] = new Product("strings", "6-Pack Standard Strings",  7.99);
products[10] = new Product("gretsch", "Gretsch-G542T",  495.85);
products[11] = new Product("splitv", "Black Split-V",  1259.95);
products[12] = new Product("strat", "Fender Stratocaster",  359.55);
products[13] = new Product("vintagegibson", "Vintage Gibson",  14400);
products[14] = new Product("vintagestrat", "Vintage Strat",  24299.99);
products[15] = new Product("amp1", "Classic Electric Guitar Amp",  250);
products[16] = new Product("cliptuner", "Clip-on Electronic Tuner",  14.99);
products[17] = new Product("quarterinch", "Quarter Inch Cable (10ft)",  6.99);
products[18] = new Product("pedal", "Distortion Pedal",  49.99);
products[19] = new Product("pedalboard", "Pedalboard Frame",  36.95);
...
var free_shipping_quota = 100     // applied if free_shipping_allowed, set to 0.00 for always free
